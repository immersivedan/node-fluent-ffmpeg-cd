...
var ARGLISTS = ['_global', '_audio', '_audioFilters', '_video', '_videoFilters', '_sizeFilters', '_complexFilters', '_mainOptions'];
...
function FfmpegCommand(input, options) {
  ...
  var self = this;
  ['_global', '_complexFilters', '_mainOptions'].forEach(function(prop) {
